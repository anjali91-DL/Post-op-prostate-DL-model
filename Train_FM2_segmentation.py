...
class FM2_segmentation():
    ...
    def preprocessing_train(self):
         ...
         np.save(os.path.join(self.main_pred_dir, 'z_train.npy'), self.z_VALID)
    ...
    def preprocessing_valid(self):
         ...
         self.x_centtrain, self.y_centvalid = calculate_centroid_segvalid(self.valid_pat,
         ...
         np.save(os.path.join(self.main_pred_dir, 'z_endvalid.npy'), self.z_endtrainvalid)
