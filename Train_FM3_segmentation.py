...
class FM3_segmentation():
    ...
    def preprocessing_valid(self):
         ...
         np.save(os.path.join(self.main_pred_dir, 'valid.npy'), self.z_valid)
    ...
    def train(self):
        ...
        self.FM3_network = unet_3D_ResNeXt_DB(self.img_rows, self.img_cols,self.img_slcs, cardinality=4,channels_in=1, channels_out=1,
        ...
        self.FM3_network.compile(optimizer=Adam(lr=1e-2), loss=weighted_dice_loss3D, metrics=[dice_coef])
